...
////////////////////////////////////////////////////////////////////////////////
//////////////////version10 add delte event,and check by budgetController.testing(),event delegation
//var budgetController = (function () {
//    var Expense = function (id, description, value) { //function constructor first letter capital
//        this.id = id;
//        this.description = description;
...
//            //[1 2 4 6 8]
//            //index =3
//            var ids = data.allItems[type].map(function (current) { //array map method always backw with new array
//                return current.id;
//
//            });
//            index = ids.indexOf(id);
//            if (index !== -1) { //if not exist ,no delete 
//                data.allItems[type].splice(index, 1);//i means delete 1 element
//            }
//        },
//
//        getBudget: function () {
...
//
//        },
//        displayPercentages: function (percentages) { //percentages will be a array
//            var fields = document.querySelectorAll(DOMstrings.expensesPercLabel); //nodelist not have for each,we haveto define own
...
///////////////////////////////////version14 Formatting Our Budget Numbers: String Manipulation
//var budgetController = (function () {
//    var Expense = function (id, description, value) { //function constructor first letter capital
//        this.id = id;
//        this.description = description;
...
//        },
//
//        //        formatNumber: function (num, type) {//public method,found private enough so move out of return
//        //            num = Math.abs(num);
//        //            num = num.toFixed(2); //number and string will automatically convert to object if apply method on them
//        //            numSplit = num.split('.'); //split into integer and decimal 
//        //            int = numSplit[0];
//        //
//        //            if (int.length > 3) {
...
///////////////////////////////////version15 Displaying the Current Month and Year
//var budgetController = (function () {
//    var Expense = function (id, description, value) { //function constructor first letter capital
//        this.id = id;
//        this.description = description;
...
/////////////////////////////////version16 Finishing Touches: Improving the UX,toggle to red for expense
var budgetController = (function () {
    var Expense = function (id, description, value) { //function constructor first letter capital
        this.id = id;
        this.description = description;
...
var UIController = (function () {
    ...
    return {
        ...
        displayPercentages: function (percentages) { //percentages will be a array
            ...
            //                for (var i = 0; i < list.length; i++) {
            //                    callback(list[i], i);
            //                }//we need use nodeListEach in improving THE ux of eventListener,so move out of displayPercentage function into  
            //            };
            nodeListForEach(fields, function (current, index) {
                if (percentages[index] > 0) {
                    current.textContent = percentages[index] + '%';
        ...
        changedType: function () {
            ...
            nodeListForEach(fields, function (cur) { //add problem is red color always there even lose focus
