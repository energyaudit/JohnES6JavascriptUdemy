...
// //////////////////////////////////////version 10,Building the like menu,reuse searchview limitRecipeTitle
// import { elements } from "./base";
// export const getInput = () => elements.searchInput.value;
// export const clearInput = () => {
//   elements.searchInput.value = "";
...
// const resultsArray =Array.from(document.querySelectorAll('.results__link'));//querySelectorAll must have the . infront of class results__link ornot not work 
// resultsArray.forEach(el=>{el.classList.remove('results__link--active');});
// document.querySelector(`.results__link[href="#${id}"]`).classList.add('results__link--active');//use atrribute has #id link to identify the cliecked search
// };
// /*
// // 'Pasta with tomato and spinach'
// acc: 0 / acc + cur.length = 5 / newTitle = ['Pasta']
...
// acc: 18 / acc + cur.length = 24 / newTitle = ['Pasta', 'with', 'tomato']
// */
// export const limitRecipeTitle = (title, limit = 17) => {//add export here that likesView use this function
//   const newTitle = [];
//   if (title.length > limit) {
//     title.split(" ").reduce((acc, cur) => {
//       //acc-accumulator, cur-current
...
//////////////////////////////////////version 10,Building the like view, Implementing Persistent Data with localStorage
import { elements } from "./base";
export const getInput = () => elements.searchInput.value;
export const clearInput = () => {
  elements.searchInput.value = "";
