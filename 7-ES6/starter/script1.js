...
console.log("key showing as number,string,bullen in following exp:   ", question);
...
question.forEach((value, key) => console.log("map for each loop:   ", `This is ${key}, and it's set to ${value}`));
